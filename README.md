...
Plugin source: see `LICENSE`. Third-party SDKs (JUCE / VST3 / AAX / WebView2, etc.) are licensed separately; the runtime dependency list is shown in the *Licenses* dialog inside the plugin UI.
