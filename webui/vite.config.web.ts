...
/**
 * public/ (共有) と public-web/ (Web 専用 = WASM / worklet) の両方を配信する Vite プラグイン。
...
function mergePublicWeb(): Plugin {
  ...
  return {
    ...
    configureServer(server) {
      ...
      // public-web 配下のファイルを Vite 既定の public/ と重ねて配信
 ...
 * 5. public-web/ から WASM / worklet を配信
 */
